...
namespace APSmartHome.Business.Helper
{
   public class SecurityHelper
    {
        ...
        public static X509Certificate2 GetRSAProviderFromPvkFile(string kpvBase64)
        {
            X509Certificate2 cert = new X509Certificate2(Convert.FromBase64String(kpvBase64));
            return cert;
        }
        public static RSACryptoServiceProvider GetRSAProviderFromPemFile(string pubKey,bool isPrivateKeyFile)
        {
            string pemstr = pubKey;
